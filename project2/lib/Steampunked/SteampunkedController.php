...
class SteampunkedController {
    public function __construct($site, Steampunked $steampunked, $post, array &$session)
    {
        ...
        $currentPlayerId = $steampunked->getCurrPlayerId();
        $currentGameId = $session['gameId'];

        $games =new Games($site);
        $this->page = $games->updateTurn($currentGameId, $currentPlayerId);
